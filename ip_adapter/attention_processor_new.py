...
class Attention(nn.Module):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, attention_mask=None, **cross_attention_kwargs):
        ...
        #attn_keys = cross_attention_kwargs.pop('attn_keys', None)
        #print("\n",self.processor,"\n")
        return self.processor(
            self,
            hidden_states,
...
class CustomDiffusionAttnProcessor(nn.Module):
    ...
    def __call__(self, attn: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None,attn_key=None,
                attn_process_fn=None,
                return_cond_ca_only=False,
                return_token_ca_only=None,
                offload_cross_attn_to_cpu=False,
